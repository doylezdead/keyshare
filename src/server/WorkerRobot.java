...
public class WorkerRobot {
	...
	/**
	 * recieves an array of integers [0]: (0,1,2,3) 0: mouse click [1]: (0,1) 0:
	 * mouse press 1: mouse release [2]: (0,1,2) 0: left button 1: middle button
	 * 2: right button 1: mouse wheel [1]: number of notches 2: mouse motion
	 * [1]: x coordinates [2]: y coordinates 3: keyboard [1]: (0,1) 0: key press
	 * 1: key release [2]: key number
	 */
